...
static const Album ALBUMS[] = {
  { 1, "FIFA", "Mejores canciones", 1, 240, TRACKS_01, 0x1DB954 },
  { 2, "ZELDA", "Mejores canciones", 1, 80, TRACKS_02, 0x3A6FD8 },
  { 3, "MINECRAFT", "Bandas sonoras", 2, 294, TRACKS_03, 0xC8791E },
  { 4, "RELAX", "Para bajar el ritmo", 3, 555, TRACKS_04, 0xB5476B },
};
