 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font arduino-libs/libraries/lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x30-0x3A --size 96 --bpp 4 --format lvgl --lv-include lvgl.h --no-compress -o ../firmware/TAC1/tac_reloj_96.c
 ******************************************************************************/
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t tac_reloj_96 = {
#else
lv_font_t tac_reloj_96 = {
#endif
